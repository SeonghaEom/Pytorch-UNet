...
def train_net(net,
    ...
    experiment = wandb.init(project='U-Net', entity='seonghaeom', resume='allow')
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                assert images.shape[1] == net.n_channels, \
                    ...
                    f'{images.shape}, {true_masks.shape}'
        ...
        if division_step > 0:
            if global_step % division_step == 0:
                ...
                logging.info('Jaccard score: {}'.format(val_score/(2 - val_score)))
                experiment.log({
                    'learning rate': optimizer.param_groups[0]['lr'],
                    'validation Dice': val_score,
                    'jaccard score': val_score/(2 - val_score),
        ...
        if save_checkpoint and (val_score > best_score):
            ...
            torch.save(net, str(dir_checkpoint / 'model_epoch{}_{}_best.pth'.format(epoch, s)))
            torch.save(net.state_dict(), str(dir_checkpoint / 'checkpoint_epoch{}_{}_best.pth'.format(epoch, s)))
